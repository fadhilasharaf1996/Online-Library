...
<!-- We use while loop to fetch data and display rows of date on html table -->
        ...
        <?php
          ...
          while ($course = mysqli_fetch_assoc($records)){
                ...
                echo "<tr>";
                    ...
                    ?>
                    <td>
                      <button type="button" name="delete"><a href="delete.php?id=<?php echo $course['id'];?>">DELETE</a></button>
                    </td><?php
                echo "</tr>";
      ...
      <button type="button" name="addbook"><a href="book_register.php">Add New Books</a></button>
